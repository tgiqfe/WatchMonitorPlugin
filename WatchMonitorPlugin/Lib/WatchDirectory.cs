...
{
    internal class WatchDirectory : WatchPath
    {
        public WatchDirectory(bool? isCreationTime, bool? isLastWriteTime, bool? isLastAccessTime,
            bool? isAccess, bool? isOwner, bool? isInherited, bool? isAttributes,
            bool? isMD5Hash, bool? isSHA256Hash, bool? isSHA512Hash, bool? isSize, bool? isChildCount)
        {
